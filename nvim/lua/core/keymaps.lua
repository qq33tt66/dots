...
vim.keymap.set("n", "<leader>ff", "<Cmd>Pick files<CR>", { desc = "Modified hunks (buf)" })
vim.keymap.set("n", "<leader>f.", function()
	MiniPick.builtin.files(nil, { source = { cwd = vim.fn.expand("%:p:h") } })
end, { desc = "Files (current dir)" })
...
vim.keymap.set("n", "<leader>gn", "<Cmd>edit $MYVIMRC<CR>", { desc = "init.lua" })
